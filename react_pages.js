...
var hoist_non_react_statics = __webpack_require__(14);
...
var symbol_observable = __webpack_require__(27);
...
function combineReducers(reducers) {
  ...
  for (var i = 0; i < reducerKeys.length; i++) {
    ...
    if (process.env.NODE_ENV !== 'production') {
      if (typeof reducers[key] === 'undefined') {
        warning_warning('No reducer provided for key "' + key + '"');
      }
    }
  ...
  return function combination() {
    ...
    if (process.env.NODE_ENV !== 'production') {
      ...
      if (warningMessage) {
        warning_warning(warningMessage);
      }
    }
...
if (process.env.NODE_ENV !== 'production' && typeof isCrushed.name === 'string' && isCrushed.name !== 'isCrushed') {
  warning_warning('You are currently using minified code outside of NODE_ENV === \'production\'. ' + 'This means that you are running a slower development build of Redux. ' + 'You can use loose-envify (https://github.com/zertosh/loose-envify) for browserify ' + 'or DefinePlugin for webpack (http://stackoverflow.com/questions/30030031) ' + 'to ensure you have the correct code for your production build.');
}
...
var node_modules_warning_warning = __webpack_require__(1);
...
var history_createBrowserHistory = __webpack_require__(31);
...
function Router__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function Router__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function Router__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var Router_Router = function (_React$Component) {
  Router__inherits(Router, _React$Component);

  function Router() {
    var _temp, _this, _ret;

    Router__classCallCheck(this, Router);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = Router__possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
      match: _this.computeMatch(_this.props.history.location.pathname)
    }, _temp), Router__possibleConstructorReturn(_this, _ret);
  }
...
var history_createHashHistory = __webpack_require__(32);
...
var history_createMemoryHistory = __webpack_require__(33);
...
var path_to_regexp = __webpack_require__(34);
...
var resolve_pathname = __webpack_require__(15);
...
var Landing = __webpack_require__(36);
...
var styles_ProjectsPage = __webpack_require__(37);
...
var styles_TopNav = __webpack_require__(38);
...
var server = __webpack_require__(39);
...
var redux_logger = __webpack_require__(46);
...
var composedStore = compose(applyMiddleware(redux_logger_default.a));

var store_buildClientStore = function buildClientStore(state) {
  return composedStore(createStore_createStore)(reducers_clientStoreBuilder(state));
};
var store_buildServerStore = function buildServerStore(state) {
  return createStore_createStore(reducers_serverStoreBuilder(state));
};
...
var server_context = { serverSide: true };
...
var server_IndexRoute = function IndexRoute(req, res) {
  ...
  res.send(render_page(react_default.a.createElement(
    components_Provider,
    { store: store },
    react_default.a.createElement(
      react_router_dom_es_StaticRouter,
      { location: req.url, context: server_context },
...
var m=__webpack_require__(5),n=__webpack_require__(8),p=__webpack_require__(4),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
var k=__webpack_require__(5),r=__webpack_require__(0),aa=__webpack_require__(4),t=__webpack_require__(8),ba=__webpack_require__(18),ca=__webpack_require__(19),da=__webpack_require__(20);
