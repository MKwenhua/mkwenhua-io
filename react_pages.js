...
var styles_ProjectsPage = __webpack_require__(7);
...
var external__react_router_ = __webpack_require__(9);
...
var external__redux_logger_ = __webpack_require__(11);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProjectRoute", function() { return server_ProjectRoute; });
...
var server_IndexRoute = function IndexRoute(req, res) {
  var store = store_buildServerStore(server_defaultState);
  console.log('store', store);
  console.log('defaultState', server_defaultState);
...
var server_ProjectRoute = function ProjectRoute(req, res) {
  var store = store_buildServerStore(server_defaultState);
  console.log('store', store);
  console.log('defaultState', server_defaultState);
